...
mii2studio cannot read from a QR code yet, but you can [decode a QR code here](https://3ds.goombi.fr/editMii/), [decrypt it with this](https://gist.github.com/jaames/96ce8daa11b61b758b6b0227b55f9f78), and run it through mii2studio.
